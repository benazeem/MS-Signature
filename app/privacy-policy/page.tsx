          ...
          {sections.map((section, i) => (
            <ScrollReveal key={section.title} delay={i * 0.05}>
              <div className="border-b border-border pb-10">
                <h2 className="font-heading text-xl text-text-light mb-4">
                  {section.title}
                </h2>
